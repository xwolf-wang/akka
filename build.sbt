...
lazy val akkaScalaNightly = akkaModule("akka-scala-nightly")
  ...
  .disablePlugins(MimaPlugin)
  .disablePlugins(MimaPlugin, CopyrightHeaderInPr) //FIXME ValidatePullRequest
...
lazy val benchJmh = akkaModule("akka-bench-jmh")
  ...
  .enablePlugins(JmhPlugin, NoPublish, CopyrightHeader) // FIXME ScaladocNoVerificationOfDiagrams
  .disablePlugins(MimaPlugin, WhiteSourcePlugin, CopyrightHeaderInPr) // FIXME ValidatePullRequest
